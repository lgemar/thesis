...
make clean
make 2>&1 | tee ../../../z_Install/win64_build/logs/71_icon-naming-utils-make.log
make install 2>&1 | tee ../../../z_Install/win64_build/logs/71_icon-naming-utils-makeinstall.log
